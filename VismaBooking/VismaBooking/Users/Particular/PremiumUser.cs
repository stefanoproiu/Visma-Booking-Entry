...
{
    //Can make up to 3 bookings at a time - ok
    //Has access to Classrooms and Boardrooms - ok
    //Can view when a certain room will be available for booking - ok
    class PremiumUser:User
    {
        ...
        public override void buildGUI(Form form)
        {
            ...
            foreach (TabPage tp in tabs[0].TabPages)
                tp.BackColor = System.Drawing.Color.LightYellow;
        }
    }
}
