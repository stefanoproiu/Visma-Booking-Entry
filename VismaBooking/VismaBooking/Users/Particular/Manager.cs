...
{
    //Can see and cancel the bookings of Basic Users and Premium Users - ok
    //Can create Basic Users and Premium Users accounts - ok
    //Has access to Classrooms,Boardrooms,Theatres - ok
    class Manager:User
    {
        private short _id;
        ...
        public override void buildGUI(Form form)
        {
            ...
            foreach (TabPage tp in tabs[0].TabPages)
                tp.BackColor = System.Drawing.Color.PaleVioletRed;
        }
    }
}
